...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    shortDescription: 'Relaxing 10km river float with wildlife spotting and traditional snacks.',
    description: 'Enjoy a relaxing half-day tour just 25 minutes from La Fortuna. Guided by expert naturalist guides, you’ll embark on a peaceful 10km (6.2 miles) journey down the Peñas Blancas River, spotting sloths, monkeys, toucans, crocodiles, and more.<br /><br />The experience concludes at “Tita Yolanda’s” authentic kitchen with a traditional Costa Rican snack: homemade tortillas, ripe plantains, fresh cheese, and coffee. Plus, visit a rustic station for a fascinating explanation and tasting of traditional chocolate and sugarcane juice. This tour can be operated by raft or kayak.',
    duration: '4 hours',
    difficulty: 'Easy',
    category: 'Wildlife',
...

  {
    ...
    shortDescription: '2-hour guided kayak tour on Lake Arenal with spectacular volcano views.',
    description: 'Enjoy a 2-hour kayak tour across the breathtaking waters of Lake Arenal, paddling while enjoying spectacular views of the iconic Arenal Volcano. Our expert guides will share fascinating stories and interesting facts about the area’s history and creation. At the end of this unique adventure, recharge with a refreshing snack of delicious tropical fruits. This tour is ideal for travelers wanting to connect with La Fortuna’s natural beauty through an active and fun experience.',
    duration: '3 hours',
    difficulty: 'Moderate',
    category: 'Water',
  ...
  // =========================
  {
    ...
    shortDescription: 'Unique hike through primary forest, ancient lava flows, and stunning viewpoints.',
    description: 'Discover the magic of the imposing Arenal Volcano (1,657m) with a guided adventure. The journey begins on the El Silencio Trail, a unique 4km (2.5-mile) path through primary forest filled with lush vegetation and giant trees. After leaving the forest, you’ll walk across ancient lava flows from the historic 1968 eruption while learning fascinating facts about the volcano’s activity. Enjoy stunning views of the green lagoon and Lake Arenal, followed by a refreshing tropical fruit tasting at the end of the tour.',
    duration: '3.5 hours',
    difficulty: 'Moderate',
    category: 'Hiking',
...

  {
    ...
    shortDescription: '6km hike through Tenorio Volcano National Park to witness the stunning blue river and waterfall.',
    description: 'This hike combines the natural beauty of the rainforest with the perfect opportunity to observe its fascinating flora and fauna. Along a 6 km (3.7 miles) trail through Tenorio Volcano National Park, we will walk among jungle trails and cross two crystalline streams that form the famous Celeste River. Witness the magical azure blue color, explore geothermal activity areas with volcanic smoke, and visit the spectacular Rio Celeste waterfall. The tour ends with a delicious typical lunch at a local restaurant.',
    duration: 'Full day',
    difficulty: 'Hard',
    category: 'Hiking',
  ...
  },
  {
    ...
    title: 'Sloth Tour',
    shortDescription: 'Relaxed 800m hike through the rainforest to spot sloths and enjoy local snacks.',
    description: 'Enjoy a relaxed 800-meter hike along scenic natural trails, suitable for all ages and fitness levels. As you stroll through the lush Costa Rican rainforest, keep an eye out for the charming sloths hanging in the trees — truly a sight to behold. Surrounded by vibrant wildlife and the calming sounds of nature, this hike is the perfect way to connect with the environment. At the end of your adventure, enjoy a delicious local snack to cap off this unforgettable experience.',
    duration: '2.5 hours',
    difficulty: 'Easy',
    category: 'Wildlife',
  ...
  // =========================
  {
    ...
    title: 'Unique Caño Negro Experience',
    shortDescription: 'Explore the wetlands with a boat tour, traditional lunch, and cultural lessons.',
    description: 'Discover the incredible biodiversity of the Caño Negro Wildlife Refuge. This experience blends nature, culture, and tradition, starting with a scenic drive through rural landscapes to Los Chiles. Enjoy a refreshing snack before embarking on a two-hour boat tour along the Río Frío, where you can spot exotic birds, monkeys, iguanas, caimans, and the rare orange howler monkey.<br /><br />The adventure concludes with a traditional Costa Rican lunch made with local ingredients, followed by a sweet cultural lesson on sugarcane and cacao — two essential elements of Costa Rica’s heritage.',
    duration: 'Full day',
    difficulty: 'Easy',
    category: 'Wildlife',
  ...
  // =========================
  {
    ...
    shortDescription: 'Explore the rainforest canopy through a network of 16 bridges.',
    description: 'Explore the wonders of the rainforest and enjoy breathtaking views of the Arenal Volcano from above. This 3.5 km (2-mile) hike through the lush primary rainforest takes you across a network of 6 stunning hanging bridges and 10 metal-structure bridges, offering unique vantage points to observe wildlife at different heights. Spot mammals, birds, snakes, and insects in their natural habitat, and top off the experience with a refreshing tasting of local tropical fruits.',
    duration: '4 hours',
    difficulty: 'Moderate',
    category: 'Hiking',
